...
function Padang({ onReturn, stats, updateStats, inventory, addToInventory }) {
  ...
  return (
    <div className="town">
      {/* Return Button */}
      <button onClick={handleReturn} className="return-button" style={{ right: '20px' }}>
      ...
      >
        ...
        <div className="stat-item" style={{ marginLeft: '-40px' }}>
          <span>Gold:</span>
          <span className="gold-amount" style={{ marginLeft: '10px' }}>{stats.gold}</span>
        </div>
      </div>
      ...
      {showInventory && (
        <div className="inventory-modal" style={{
          ...
          <div className="inventory-content" style={{
            ...
            <div className="inventory-items" style={{
              ...
              {inventory.length === 0 ? (
                <p style={{ 
                  ...
                  gridColumn: '1 / -1',
                  padding: '20px'
                }}>Belum ada bahan yang dikumpulkan.</p>
              ) : (
